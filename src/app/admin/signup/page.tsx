...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    const { data, error } = await supabase.auth.signUp({
      ...
      password,
      options: {
        data: { full_name: name, role, account_type: accountType, ...(normalizedPhone && { phone: normalizedPhone }) },
    ...
    createAdminNotification({
      ...
      message: `${name} (${normalizedEmail}) signed up as a ${typeLabel.toLowerCase()} and is waiting for approval.`,
      link: '/admin/users',
    });
    ...
    fetch('/api/admin/notify-signup', {
      ...
      body: JSON.stringify({ name, email: normalizedEmail, accountType }),
      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSignup} className="bg-white rounded-xl shadow-2xl p-8 space-y-5">
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">Add your phone to enable phone login later.</p>
          </div>
